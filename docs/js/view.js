        ...
        case 'chat':
            {
                ...
                firebase.firestore().collection("users")
                    ...
                    .then(function (querySnapshot) {                        
                        querySnapshot.forEach(function (doc) {
                            document.getElementById('change-firstname').value = doc.data().firstName
                            document.getElementById('change-lastname').value = doc.data().lastName
                            document.getElementById('change-email').value = firebase.auth().currentUser.email
                        });
                    })
                ...
                let formChangeUserInfor = document.getElementById('change-user-infor-form')
                formChangeUserInfor.onsubmit = formChangeUserInforHandler
                ...
                function formChangeUserInforHandler(e){
                    e.preventDefault()
                    console.log(formChangeUserInfor.avatar.src);
                    let UserInfo = {
                        firstName: formChangeUserInfor.firstname.value,
                        lastName: formChangeUserInfor.lastname.value,
                        email: formChangeUserInfor.email.value,
                        avatar: formChangeUserInfor.avatar.src,
                        background: formChangeUserInfor.background.src
                    }
                    controller.changeUserInfo(UserInfo)
